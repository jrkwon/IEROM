...
**
** DESCRIPTION:
**            Tissue Region Extraction Engine (TREE) for KESM Images
**            Input: input Path with jpeg files of KESM raw images
**                   output Path where the output csv file should be stored
**            Output: csv file with tissue file name and extraction side
**                    (left or right) & start pixel-index of tissue in image.
**
** AUTHOR:
**        Shruthi Raghavan
**
...
int main(int argc, char *argv[])
{
  ...
  QString inPath = "E:/test";
  QString outPath = "E:/out";
  ...
  QString filename = outPath + "/finalresult_test.csv";
  QFile file(filename);
